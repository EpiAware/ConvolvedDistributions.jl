...
# ---------------------------------------------------------------------------
#
# The two-component case routes through the solver-method dispatch in
# solver_dispatch.jl (S1); this pairwise fold over `_try_convolve`
# (solver_dispatch.jl) is what three-or-more components still use (S1.6).
