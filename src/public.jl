...
# A caller-supplied delay PMF is a plain `AbstractVector{<:Real}` of masses,
# or a `Distributions.DiscreteNonParametric` for a non-unit or shifted lag
# grid (#79); `convolve_series` accepts either. This package does not
