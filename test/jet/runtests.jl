...
if @isdefined(JET_REPORT_FILTER)
    result = JET.report_package(ConvolvedDistributions;
        target_modules = (ConvolvedDistributions,))
    ...
    JET.test_package(ConvolvedDistributions; target_modules = (ConvolvedDistributions,))
end
