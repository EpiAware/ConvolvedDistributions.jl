...
Welcome to the ConvolvedDistributions.jl developer documentation.
...
- **[Adding a new combination](@ref extending)**: The `AbstractConvolvedDistribution` contract and the conventions `Convolved`, `Difference`, and `Product` follow, as a template for a new family member
