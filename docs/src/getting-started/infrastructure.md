...
`ConvolvedDistributions` adopts shared configuration and test infrastructure from
...
Two pieces keep `ConvolvedDistributions` aligned with the kit.
...
update("path/to/ConvolvedDistributions.jl")
```
