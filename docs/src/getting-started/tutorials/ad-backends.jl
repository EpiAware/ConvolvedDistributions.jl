...
ConvolvedDistributions.jl composes with Julia's automatic differentiation (AD)
...
[![AD](https://github.com/EpiAware/ConvolvedDistributions.jl/actions/workflows/ad.yaml/badge.svg?branch=main)](https://github.com/EpiAware/ConvolvedDistributions.jl/actions/workflows/ad.yaml)
