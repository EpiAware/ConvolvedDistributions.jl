...
```@meta
EditURL = "https://github.com/EpiAware/ConvolvedDistributions.jl/blob/main/NEWS.md"
```
...
See [GitHub Releases](https://github.com/EpiAware/ConvolvedDistributions.jl/releases) for minor/patch
release information.
